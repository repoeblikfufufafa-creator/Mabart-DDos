...
print(f"\033[31m╔{'═' * 53}╗\033[0m")
print(f"\033[31m║\033[100m \033[32m  v.2.0{' ' * 45}\033[31m║\033[0m")
print(f"\033[31m║\033[100m \033[32m  Author By: KunFayz{' ' * 32}\033[31m║\033[0m")
print(f"\033[31m╚{'═'  * 53}╝")
...
while attemps < 100:
    ...
    if username == 'termul' and password == '0geb':
        print("\033[32m⟩⟩ Welcome to zona attack for Free Palistine \033[0m")
        break
    else:
...
\033[1;31m╚═════════════════════════════════════════════════════╝""")
	...
	if proxy == None:
		while True:
			...
			print(Back.YELLOW+Fore.WHITE+"Proxy-attack" +Fore.BLUE "Found {} new proxies".format(len(array))+Style.RESET_ALL)
